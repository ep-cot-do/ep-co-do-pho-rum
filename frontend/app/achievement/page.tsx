...
const achievements: (AchievementItem & {
...
})[] = [
  {
    ...
    description:
      "Paper accepted at International Conference on Machine Learning",
    level: "gold",
    member: "Nguyen Hoang Khang",
    date: "June 12, 2023",
    details:
      "Research on 'Optimizing Neural Networks for Edge Devices' was accepted at ICML 2023.",
  ...
  },
  {
    ...
    date: "June 12, 2023",
    details:
      "Research on 'Generative Models for Synthetic Data' was accepted at ICML 2023.",
  ...
  },
  {
    ...
    date: "March 20, 2023",
    details:
      "Contributed performance improvements to React's rendering engine, merged by core team.",
  ...
  },
  {
    ...
    details:
      "Led a team of 4 to develop an educational platform for teaching programming to children.",
  ...
  },
  {
    ...
    details:
      "Designed and developed 'StudyFlow', a pomodoro and note-taking app for students.",
  ...
  },
  {
    ...
    details:
      "Led a hands-on workshop teaching 50+ students about React hooks and modern patterns.",
  ...
  },
  {
    ...
    details:
      "Article about 'Building accessible React components' featured on DEV.to weekly digest.",
  ...
  },
  {
    ...
    date: "October 1, 2022",
    details:
      "Selected for the competitive Software Engineering Internship program at Google Singapore.",
...
export default function AchievementPage() {
  ...
  const filteredAchievements = achievements.filter((achievement) => {
    ...
    if (selectedTimeframe !== "all") {
      ...
      if (selectedTimeframe === "month") {
        ...
        matchesTimeframe =
          achievementQuarter === currentQuarter &&
          achievementDate.getFullYear() === now.getFullYear();
    ...
    if (level === "gold") {
      ...
      return (
        ...
        >
          <IconMedal
            size={14}
            className={isDark ? "text-zinc-300" : "text-zinc-500"}
            stroke={1.5}
          />
          Silver
        </span>
  ...
  return (
    <LayoutWrapper maxWidth="w-full">
      ...
      {/* Filters Bar */}
      <div
        className={`p-4 mb-6 rounded-xl flex flex-col gap-4 ${
          isDark
            ? "bg-zinc-800/30"
      ...
      >
        ...
        <div
          ...
          } sm:flex flex-col sm:flex-row gap-3 sm:gap-4`}
        >
          {/* Level Filter */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {filteredAchievements.length > 0 ? (
          filteredAchievements.map((achievement, index) => (
            <div
              key={index}
              className={`rounded-xl overflow-hidden transition-all hover:-translate-y-1 cursor-pointer ${
                isDark
          ...
          <div
            className={`col-span-1 sm:col-span-2 lg:col-span-3 p-8 text-center rounded-xl ${
              isDark ? "bg-zinc-800/30" : "bg-white border border-zinc-100"
            }`}
          >
            <p className={isDark ? "text-zinc-400" : "text-zinc-500"}>
              No achievements match your filters. Try adjusting your search
              criteria.
            </p>
          </div>
        )}
      ...
      {selectedAchievement && (
        ...
        >
          <div
            className={`relative w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 rounded-xl m-4 ${
