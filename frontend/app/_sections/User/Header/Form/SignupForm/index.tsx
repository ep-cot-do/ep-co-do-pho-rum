  ...
  return (
    <div className="relative min-h-[600px] w-full max-w-lg mx-auto">
      ...
      <div className={`absolute inset-0 rounded-3xl ${isDark
        ...
        } backdrop-blur-xl border ${isDark ? 'border-white/10' : 'border-white/20'
        } shadow-2xl`} />

      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden rounded-3xl">
        <div className={`absolute -top-20 -right-20 w-40 h-40 rounded-full ${isDark ? 'bg-purple-500/10' : 'bg-blue-200/20'
          } blur-3xl animate-pulse`} />
        <div className={`absolute -bottom-20 -left-20 w-32 h-32 rounded-full ${isDark ? 'bg-blue-500/10' : 'bg-purple-200/20'
      ...
      >
        ...
        <div className="flex justify-between items-start p-4 pb-2 sticky top-0 z-20 rounded-t-3xl" style={{
          background: isDark
          ...
          <div className="space-y-2">
            ...
            >
              <div className={`relative w-12 h-12 rounded-2xl flex items-center justify-center ${isDark ? 'bg-gradient-to-br from-purple-600 to-blue-600' : 'bg-gradient-to-br from-blue-600 to-purple-600'
                } shadow-lg`}>
              ...
              <span className={`text-2xl font-bold bg-gradient-to-r ${isDark
            ...
            >
              ...
              <p className={`text-sm ${isDark ? 'text-gray-300/80' : 'text-gray-600'
                }`}>
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4 modal-scroll">
          ...
          >
            ...
            <div className="space-y-3">
              <h3 className={`text-sm font-bold ${isDark ? 'text-purple-300' : 'text-blue-700'
                } border-b-2 ${isDark ? 'border-purple-500/30' : 'border-blue-300'
                } pb-2 mb-4`}>
                Basic Information
              </h3>
              ...
              `}>
                ...
                `}
                  ...
                  />
                  <div className={`absolute inset-0 rounded-xl pointer-events-none transition-opacity duration-300 ${isDark ? 'bg-gradient-to-r from-purple-500/0 to-blue-500/0 group-focus-within:from-purple-500/10 group-focus-within:to-blue-500/10' :
          ...
          >
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`px-4 py-1 rounded-full ${isDark
